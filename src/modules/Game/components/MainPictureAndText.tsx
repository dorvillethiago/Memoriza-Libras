    ...
    if (mobile) {
        return (
            <div
                ...
                <img className="rounded-xl w-[140px] image-shadow color-filter hover:-rotate-6 transition-transform hover:scale-105 hover:cursor-pointer" src={letter.url} alt={letter.str}/>
        ...
        return (
            <div
                ...
                <img className="rounded-xl w-[180px] image-shadow color-filter hover:-rotate-6 transition-transform hover:scale-105 hover:cursor-pointer" src={letter.url} alt={letter.str}/>
                <span className={`relative z-10`}>
